...
OPS = {
    ...
    'conv_5_3':        lambda C: ConvReLU(C, C, 5, 3),
    'conv_7_3':        lambda C: ConvReLU(C, C, 7, 3),
    'conv_9_3':        lambda C: ConvReLU(C, C, 9, 3),
    'conv_7_4':        lambda C: ConvReLU(C, C, 7, 4),
    'conv_9_4':        lambda C: ConvReLU(C, C, 9, 4),
