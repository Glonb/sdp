...
OPS = {
    ...
    'smp_conv_3':   lambda C, stride, affine: ReLUConvBN(C, C, 3, stride, 1, affine=affine),
    'smp_conv_5':   lambda C, stride, affine: ReLUConvBN(C, C, 5, stride, 2, affine=affine),
    'smp_conv_7':   lambda C, stride, affine: ReLUConvBN(C, C, 7, stride, 3, affine=affine),
