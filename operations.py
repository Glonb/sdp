...
OPS = {
    ...
    'avg_pool_5':   lambda C, stride, affine: nn.AvgPool1d(5, stride=stride, padding=1, count_include_pad=False),
    'avg_pool_7':   lambda C, stride, affine: nn.AvgPool1d(7, stride=stride, padding=1, count_include_pad=False),
    'max_pool_3':   lambda C, stride, affine: nn.MaxPool1d(3, stride=stride, padding=1),
    'max_pool_5':   lambda C, stride, affine: nn.MaxPool1d(5, stride=stride, padding=1),
    'max_pool_7':   lambda C, stride, affine: nn.MaxPool1d(7, stride=stride, padding=1),
