...
OPS = {
    ...
    'conv_3_1':        lambda C_in, C_out: ConvReLU(C_in, C_out, 3, 1),
    'conv_4_1':        lambda C_in, C_out: ConvReLU(C_in, C_out, 4, 1),
    'conv_5_1':        lambda C_in, C_out: ConvReLU(C_in, C_out, 5, 1),
    'conv_6_1':        lambda C_in, C_out: ConvReLU(C_in, C_out, 6, 1),
    'conv_7_1':        lambda C_in, C_out: ConvReLU(C_in, C_out, 7, 1),
    'conv_3_2':        lambda C_in, C_out: ConvReLU(C_in, C_out, 3, 2),
    'conv_4_2':        lambda C_in, C_out: ConvReLU(C_in, C_out, 4, 2),
    'conv_5_2':        lambda C_in, C_out: ConvReLU(C_in, C_out, 5, 2),
    'conv_6_2':        lambda C_in, C_out: ConvReLU(C_in, C_out, 6, 2),
    'conv_7_2':        lambda C_in, C_out: ConvReLU(C_in, C_out, 7, 2),
    'conv_5_3':        lambda C_in, C_out: ConvReLU(C_in, C_out, 5, 3),
    'conv_7_3':        lambda C_in, C_out: ConvReLU(C_in, C_out, 7, 3),
